...
const ApplyVisa = () => {
    ...
    useEffect(() => {
        axios.get(`https://snj-global-agency-backend-5uzc.onrender.com/api/visas`).then(res => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('https://snj-global-agency-backend-5uzc.onrender.com/api/visas/apply', data, {
                headers: { 
