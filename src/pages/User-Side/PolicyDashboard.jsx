...
const S = {
  ...
  innerNarrow: { maxWidth: 900, margin: '0 auto', padding: '0 32px' },
  ...
  h3: {
    fontFamily: '"Times New Roman", serif',
    fontSize: 22, fontWeight: 'bold', color: NAVY2, marginBottom: 10,
  },
  body: {
    fontFamily: '"Times New Roman", serif',
...
const SectionHeader = ({ label, title, sub, center = true, light = false }) => (
  <div style={{ textAlign: center ? 'center' : 'left', marginBottom: 56 }}>
    ...
    {sub && (
      <p style={{ ...(light ? S.bodyWhite : S.body), maxWidth: 640, margin: center ? '0 auto' : '0' }}>
        {sub}
      </p>
    )}
  </div>
...
const ClauseRow = ({ number, title, children }) => (
  ...
  >
    <span style={{
      ...
      fontWeight: 'bold', color: `${GOLD}20`, lineHeight: 1,
  ...
  return (
    <div style={S.page}>
      ...
      <section style={{
        ...
        padding: '120px 50px 100px', textAlign: 'center', overflow: 'hidden',
      }}>
        <div style={{
        ...
        <div style={{
          ...
          background: `radial-gradient(ellipse at 30% 50%, ${GOLD}09 0%, transparent 55%)`,
        }} />
        <div style={{
          position: 'absolute', inset: 0, display: 'flex',
          alignItems: 'center', justifyContent: 'center',
          fontFamily: '"Times New Roman", serif',
          fontSize: 'clamp(100px, 20vw, 280px)', fontWeight: 'bold',
        ...
        >
          ...
          <p style={{ ...S.bodyWhite, maxWidth: 560, margin: '0 auto', fontSize: 17 }}>
      ...
      <section id="refund" style={S.sectionWhite}>
        <div style={S.inner}>
          ...
          <motion.div
            ...
            style={{
              background: LIGHT, borderRadius: 20, padding: '32px 36px',
              border: `1px solid ${GOLD}44`, borderLeft: `5px solid ${GOLD}`,
              marginBottom: 56, display: 'flex', gap: 24, alignItems: 'center',
            }}
          >
            <AlertTriangle size={48} color={GOLD} style={{ minWidth: 48 }} />
            <div>
              <p style={{ ...S.body, fontWeight: 'bold', color: NAVY2, marginBottom: 6 }}>
                Important Notice
              </p>
              <p style={S.body}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
            ...
            <ClauseRow number="1.1" title="Nature of Payments">
              <p style={{ ...S.body, marginBottom: 12 }}>
                <strong style={{ color: NAVY2 }}>1.1.1</strong> All payments made to the Company are service-based consultancy fees.
              </p>
              <p style={{ ...S.body, marginBottom: 8 }}>
                <strong style={{ color: NAVY2 }}>1.1.2</strong> Payments represent:
              </p>
              <BulletList items={['Professional time', 'Administrative effort', 'Advisory expertise', 'Coordination work']} />
              <p style={{ ...S.body, marginTop: 14 }}>
                <strong style={{ color: NAVY2 }}>1.1.3</strong> Payments are <em style={S.goldItalic}>not contingent on outcomes.</em>
              </p>
            </ClauseRow>

            <ClauseRow number="1.2" title="Pre-Service Refund Eligibility">
              <p style={{ ...S.body, marginBottom: 12 }}>
                <strong style={{ color: NAVY2 }}>1.2.1</strong> If cancellation is requested <em style={S.goldItalic}>before any service commencement</em>:
              </p>
              <BulletList items={[
                '(a) A partial refund may be considered',
                '(b) Administrative charges will be deducted',
                '(c) Payment gateway fees are non-recoverable',
                '(d) Internal processing costs may be deducted',
              ]} />
            </ClauseRow>

            <ClauseRow number="1.3" title="Post-Service Commencement Rule">
              <p style={{ ...S.body, marginBottom: 12 }}>
                <strong style={{ color: NAVY2 }}>1.3.1</strong> Once service begins, all payments become:
              </p>
              <BulletList items={['Fully earned', 'Non-refundable', 'Irreversible']} />
              <p style={{ ...S.body, margin: '16px 0 8px' }}>
                <strong style={{ color: NAVY2 }}>1.3.2</strong> This applies even if:
              </p>
            ...
            <ClauseRow number="1.4" title="Explicit Non-Refund Conditions">
              <p style={{ ...S.body, marginBottom: 12 }}>
                Refunds will <strong style={{ color: NAVY2 }}>not</strong> be issued for:
              </p>
              <CrossList items={[
                '(a) Visa refusal or rejection',
                '(b) Admission rejection',
                '(c) Job application rejection',
                '(d) Embassy or government refusal',
                '(e) Processing delays',
                '(f) Policy changes',
            ...
            <ClauseRow number="1.5" title="Exceptional Refund Cases">
              <p style={{ ...S.body, marginBottom: 12 }}>
                Refunds may <em style={S.goldItalic}>only</em> be considered in strictly limited situations:
              </p>
              <BulletList items={[
                '(a) Duplicate payment confirmed by system logs',
                '(b) Verified technical payment error',
                '(c) Fraudulent transaction confirmed by payment provider',
              ]} />
        ...
        <div style={S.inner}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
            ...
            <ClauseRow number="2.1" title="Data Collection Principles">
              <p style={{ ...S.body, marginBottom: 12 }}>
                <strong style={{ color: NAVY2 }}>2.1.1</strong> The Company collects only data necessary for service delivery.
              </p>
              <p style={{ ...S.body, marginBottom: 8 }}>
                <strong style={{ color: NAVY2 }}>2.1.2</strong> This may include:
              </p>
              <BulletList items={[
            ...
            <ClauseRow number="2.2" title="Purpose of Processing">
              ...
              <BulletList items={[
                ...
                '(e) Operational record keeping',
              ]} />
            </ClauseRow>

            <ClauseRow number="2.3" title="Data Sharing Restrictions">
              <p style={{ ...S.body, marginBottom: 8 }}>
                <strong style={{ color: NAVY2 }}>2.3.1</strong> Data may only be shared when necessary with:
              </p>
              ...
              <p style={{ ...S.body, marginTop: 16 }}>
                <strong style={{ color: NAVY2 }}>2.3.2</strong> The Company does{' '}
                <strong style={{ color: NAVY2 }}>not</strong>{' '}
                <em style={S.goldItalic}>sell, rent, or trade data.</em>
              </p>
            </ClauseRow>

            <ClauseRow number="2.4" title="Data Security Measures">
              <p style={{ ...S.body, marginBottom: 8 }}>
                <strong style={{ color: NAVY2 }}>2.4.1</strong> The Company implements reasonable safeguards including:
              </p>
              <BulletList items={['Access control', 'Secure storage systems', 'Restricted internal access']} />
              <p style={{ ...S.body, marginTop: 16 }}>
                <strong style={{ color: NAVY2 }}>2.4.2</strong> However, no system is fully secure, and the Client accepts inherent digital risk.
              </p>
            </ClauseRow>
        ...
        <div style={S.inner}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20, marginBottom: 56 }}>
            {[
              ...
              <motion.div
                ...
                style={{
                  background: LIGHT, borderRadius: 16, padding: '24px 20px',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
            ...
            <ClauseRow number="3.1" title="Definition">
              <p style={S.body}>
                Cookies are small data files stored on the User's device to enhance website performance. They allow our website to remember your preferences and improve the overall browsing experience.
              </p>
            </ClauseRow>
            ...
            <ClauseRow number="3.4" title="User Rights">
              ...
              <p style={{ ...S.body, marginTop: 16 }}>
                <em style={S.goldItalic}>Some features may not function properly if cookies are disabled.</em>
              </p>
            </ClauseRow>
      ...
      <section style={{ ...S.sectionNavy, position: 'relative', overflow: 'hidden' }}>
        <div style={{
          position: 'absolute', inset: 0,
          background: `radial-gradient(ellipse at 80% 20%, ${GOLD}08 0%, transparent 50%)`,
        }} />
            ...
            {[
              ...
              <motion.div
                ...
                style={{
                  ...
                  borderRadius: 20, padding: '36px 28px', textAlign: 'left',
                }}
              >
                <div style={{ marginBottom: 16 }}>{item.icon}</div>
                <h4 style={{
                  fontFamily: '"Times New Roman", serif', fontSize: 18,
                  fontWeight: 'bold', color: WHITE, marginBottom: 12,
                }}>{item.title}</h4>
      ...
      {/* ══════════ FOOTER ══════════ */}
      <footer style={{
        background: NAVY, padding: '64px 32px',
        ...
        <p style={{
          fontFamily: '"Times New Roman", serif', fontSize: 18,
          fontWeight: 'bold', letterSpacing: '4px', textTransform: 'uppercase',
