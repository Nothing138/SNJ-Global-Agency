...
const ForgotPassword = () => {
    ...
    const handleCheckUser = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post('https://snj-global-agency-backend-5uzc.onrender.com/api/admin/check-user', { email });
            if (res.data.exists) {
                setUserExists(true);
    ...
    const handleResetPassword = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.put('https://snj-global-agency-backend-5uzc.onrender.com/api/admin/reset-password-direct', { email, newPassword });
            Swal.fire({
                icon: 'success',
                title: 'Success!',
