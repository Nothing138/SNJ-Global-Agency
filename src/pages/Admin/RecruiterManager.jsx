...
const RecruiterManager = () => {
    ...
    const fetchRecruiters = async () => {
        try {
            const res = await axios.get('https://snj-global-agency-backend-5uzc.onrender.com/api/admin/recruiters/manage');
    ...
    const updateStatus = async (id, status) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await axios.patch(`https://snj-global-agency-backend-5uzc.onrender.com/api/admin/recruiters/${id}/status`, { status });
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://snj-global-agency-backend-5uzc.onrender.com/api/admin/recruiters/${id}`);
                fetchRecruiters();
            }
        });
    };
