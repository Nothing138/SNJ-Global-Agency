...
const BlogList = () => {
    ...
    const fetchBlogs = async () => {
        try {
            const res = await axios.get('https://snj-global-agency-backend-5uzc.onrender.com/api/admin/blogs');
            setBlogs(res.data);
    ...
    const handleEdit = (blog) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.put(`https://snj-global-agency-backend-5uzc.onrender.com/api/admin/blogs/${blog.id}`, result.value);
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://snj-global-agency-backend-5uzc.onrender.com/api/admin/blogs/${id}`);
                fetchBlogs();
