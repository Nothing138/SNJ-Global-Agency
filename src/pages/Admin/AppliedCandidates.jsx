...
const AppliedCandidates = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const res = await axios.get('https://snj-global-agency-backend-nhxq.onrender.com/api/admin/applied-candidates');
    ...
    const updateStatus = async (id, newStatus) => {
        try {
            await axios.patch(`https://snj-global-agency-backend-nhxq.onrender.com/api/admin/applications/${id}/status`, { status: newStatus });
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`https://snj-global-agency-backend-nhxq.onrender.com/api/admin/applications/${id}`);
                    fetchData();
