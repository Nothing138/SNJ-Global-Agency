...
const ManageRecruiters = () => {
    ...
    const fetchPending = async () => {
        try {
            const res = await axios.get('https://snj-global-agency-backend.onrender.com/api/admin/pending-recruiters');
    ...
    const handleApprove = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const res = await axios.put(`https://snj-global-agency-backend.onrender.com/api/admin/approve-recruiter/${id}`);
