...
const AnnouncementManager = () => {
    ...
    const fetchAnnouncements = async () => {
        try {
            const res = await axios.get("https://snj-global-agency-backend-5uzc.onrender.com/api/announcements/all");
    ...
    const handleCreate = async () => {
        ...
        try {
            await axios.post("https://snj-global-agency-backend-5uzc.onrender.com/api/announcements/save", {
                content,
    ...
    const toggleStatus = async (id, currentStatus) => {
        try {
            ...
            await axios.put(`https://snj-global-agency-backend-5uzc.onrender.com/api/announcements/toggle/${id}`, { is_active: newStatus });
            fetchAnnouncements();
        } catch (err) { console.error(err); }
    };
    ...
    const handleDelete = async (id) => {
        ...
        if (result.isConfirmed) {
            await axios.delete(`https://snj-global-agency-backend-5uzc.onrender.com/api/announcements/${id}`);
            fetchAnnouncements();
