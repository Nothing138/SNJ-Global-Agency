...
const JobList = () => {
    ...
    const fetchJobs = async () => {
        try {
            const res = await axios.get("https://snj-global-agency-backend-5uzc.onrender.com/api/admin/jobs/all", {
    ...
    const handleDelete = async (id) => {
        ...
        if (confirm.isConfirmed) {
            await axios.delete(`https://snj-global-agency-backend-5uzc.onrender.com/api/admin/jobs/delete/${id}`, {
                headers: { 'admin-secret-key': 'JM_IT_GLOBAL_SECURE_KEY_2026' }
            });
    ...
    const toggleStatus = async (job) => {
        ...
        try {
            await axios.put(`https://snj-global-agency-backend-5uzc.onrender.com/api/admin/jobs/update/${job.id}`, 
    ...
    const handleUpdateSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`https://snj-global-agency-backend-5uzc.onrender.com/api/admin/jobs/update/${editingJob.id}`, 
                editingJob,
                { headers: { 'admin-secret-key': 'JM_IT_GLOBAL_SECURE_KEY_2026' } }
            );
