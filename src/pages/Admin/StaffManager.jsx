...
const StaffManager = () => {
    ...
    const fetchMembers = async () => {
        try {
            const res = await axios.get('https://snj-global-agency-backend-5uzc.onrender.com/api/staff/all-members');
            setMembers(res.data);
        } catch (err) { 
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`https://snj-global-agency-backend-5uzc.onrender.com/api/staff/delete/${id}`);
    ...
    const toggleStatus = async (id, currentStatus) => {
        ...
        try {
            await axios.put(`https://snj-global-agency-backend-5uzc.onrender.com/api/staff/update-status/${id}`, { status: newStatus });
            fetchMembers();
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post('https://snj-global-agency-backend-5uzc.onrender.com/api/auth/register', { ...formData, status: 'approved', registeredBy: 'superadmin' });
