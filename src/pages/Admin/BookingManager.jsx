...
const BookingManager = () => {
    ...
    const fetchBookings = async () => {
        try {
            const res = await axios.get('https://snj-global-agency-backend-nhxq.onrender.com/api/tours/bookings');
    ...
    const handleStatus = async (id, status) => {
        try {
            await axios.put(`https://snj-global-agency-backend-nhxq.onrender.com/api/tours/update-booking/${id}`, { status });
            Swal.fire({ 
