...
const Applications = () => {
    ...
    const fetchData = async () => {
        try {
            const res = await axios.get('https://snj-global-agency-backend-nhxq.onrender.com/api/admin/visa-applications');
            setApps(res.data);
        } catch (err) {
    ...
    const handleUpdate = async (app) => {
        ...
        if (formValues) {
            try {
                await axios.put(`https://snj-global-agency-backend-nhxq.onrender.com/api/admin/visa-applications/${app.id}`, formValues);
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`https://snj-global-agency-backend-nhxq.onrender.com/api/admin/visa-applications/${id}`);
                    fetchData();
