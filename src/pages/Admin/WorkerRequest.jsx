...
export default function AdminWorkerRequests() {
  ...
  const fetchRequests = useCallback(async (silent = false) => {
    ...
    try {
      const res = await fetch(`https://snj-global-agency-backend.onrender.com/api/worker-requests`, {
  ...
  const handleUpdate = async () => {
    ...
    setUpdateMsg(null);
    try {
      const res  = await fetch(`https://snj-global-agency-backend.onrender.com/api/worker-requests/${selected.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
