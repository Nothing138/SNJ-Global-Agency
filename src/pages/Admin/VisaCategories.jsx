...
const VisaCategories = () => {
    ...
    const fetchCats = async () => {
        try {
            const res = await axios.get('https://snj-global-agency-backend-nhxq.onrender.com/api/admin/visa-categories');
    ...
    const handleAdd = async (e) => {
        ...
        if (!name.trim()) return;
        try {
            const res = await axios.post('https://snj-global-agency-backend-nhxq.onrender.com/api/admin/visa-categories', { category_name: name });
            if (res.data.success) {
                Swal.fire({ 
                    icon: 'success', 
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const res = await axios.delete(`https://snj-global-agency-backend-nhxq.onrender.com/api/admin/visa-categories/${id}`);
                    if (res.data.success) {
    ...
    const handleEdit = async (cat) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const res = await axios.put(`https://snj-global-agency-backend-nhxq.onrender.com/api/admin/visa-categories/${cat.id}`, { 
