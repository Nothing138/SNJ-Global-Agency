...
const socket = io("https://snj-global-agency-backend-5uzc.onrender.com/");
...
const Inbox = () => {
    ...
    useEffect(() => {
        const fetchChatList = async () => {
            const res = await axios.get("https://snj-global-agency-backend-5uzc.onrender.com/api/messages/chat-list");
    ...
    useEffect(() => {
        if (selectedUser) {
            ...
            const fetchHistory = async () => {
                const res = await axios.get(`https://snj-global-agency-backend-5uzc.onrender.com/api/messages/history/${adminId}/${selectedUser.id}`);
    ...
    const sendMessage = async (e) => {
        ...
        await axios.post("https://snj-global-agency-backend-5uzc.onrender.com/api/messages/send", messageData);
