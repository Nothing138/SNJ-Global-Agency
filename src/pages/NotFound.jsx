      ...
      <div className="max-w-xl w-full text-center relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
            Lost in the <span className="text-[#b02532]">Universe?</span>
          </h2>
          <p className="text-slate-500 font-medium mb-10 text-sm md:text-lg max-w-md mx-auto">
            The page you are looking for might have been moved, deleted, or never existed in our Service.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <FaSearch size={12} /> Explore Service
            </motion.button>
          </div>
        </motion.div>
      </div>
